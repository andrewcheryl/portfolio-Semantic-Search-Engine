...
class WikiAPI():
    ...
    def wiki_cats(self, cat_name='head', subcats_ids=set(), r=0, depth=2):
        ''' 
        Recursive function to pull subcatergories from the 
        whole category tree and remove duplicates
        depth controls the no of levels of subcatergories that are picked up
        '''
    ...
    def wiki_pages(self):
        ...
        return 'Unique pages to be added {} , approx load time (.5 seconds per page) {:.2}mins'.format(to_add, time_to_add)
    ...
    def write_subcats_to_mongo(self):
        ...
        try:
            ...
            print('duplicate categories not loaded')
            d+=1      
        ...
        return 'subcategories added {}, duplicates not loaded {}'. format(end-start, d)
    ...
    def load_articles(self):
        ...
        return 'pages added {}, duplicates droped {}'. format(end-start,d)
